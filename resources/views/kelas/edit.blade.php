<form action="/kelas/{{ $kelas->kode_kls }}/update" method="POST" id="formkelas">
    @csrf
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" readonly value="{{ $kelas->kode_kls }}" id="kode_kls" class="form-control" name="Kode_kls" placeholder="Kode Kelas">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $kelas->kls }}" id="kls" class="form-control" name="kls" placeholder="Kelas">
            </div>
        </div>
    </div>
    <div class="row mt-3">
